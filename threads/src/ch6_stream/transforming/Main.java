...
public class Main {
    public static void main(String[] args) {
        List<Person> persons = PersonThreeGenerator.generatePersoneList(100);
        ...
        Map<String, Long> wordCount = file.parallelStream().flatMap(line -> Stream.of(line.split("[ ,.]"))).filter(w -> w.length() > 0).sorted()
