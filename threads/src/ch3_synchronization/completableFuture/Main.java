...
public class Main {
    public static void main(String[] args) {
        ...
        CompletableFuture<Void> write2Future = step2Future.thenAccept(selected -> System.out.printf("%s: Step 2: Result -> %d\n", Thread.currentThread().getName(), selected));
        ...
        CompletableFuture<Void> finalFuture = waitFuture.thenAcceptAsync(param -> System.out.printf("Main: The CompletableFuture example has been completed"));
        finalFuture.join();
